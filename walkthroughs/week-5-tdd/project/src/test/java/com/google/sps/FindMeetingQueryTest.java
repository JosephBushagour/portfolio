...
public final class FindMeetingQueryTest {
  ...
  public void optionalCannotAttend() {
    // Have three open times but the optional attendee cannot attend any.
    //
    // Events  : |--------------C--------------|
    //         :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    ...
    Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
        new Event(
            "Event 3", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY, false),
  ...
  public void optionalCanAttendSome() {
    // Have three open times but the optional attendee can attend one.
    //
    // Events  :             |--C--|
    //         :       |--A--|     |--B--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void onlyOptionalOpen() {
    // Only optional attendees, but they're open!
    //
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
  ...
  public void onlyOptionalClosed() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)),
         new Event(
            "Event 2", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TimeRange.END_OF_DAY, false),
            Arrays.asList(PERSON_A)));
