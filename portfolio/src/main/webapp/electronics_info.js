...
const info = {
  ...
  ti81: 'A TI-81 calculator I found at a thrift store. The LCD screen ' +
      'was broken when I found it, but upon further inspection some '+
      'connections just required some re-soldering.',
  ...
  stm32MidiProject: 'This is one of my ongoing projects--a custom Midi ' +
      'keyboard. It\'s based off of an STM32C8T6F103 development board, ' +
      'which was chosen due to its relative cheapness and USB HID ' +
  ...
  cannedAir: 'Canned air, when turned upside down, can be used as a cheap ' +
      ...
      'projects.',
  snips: 'Probably the highest quality tool I own is this pair of Hakko ' +
      'flush cutters. They\'re a joy to use and are quite durable.',
